...
但是筛选的前提是拥有数据，所以第一步应该是 **获取数据并存储数据**。之后我拿出了 2 天的时间尝试去做这个事，幸运的是，在 Google 和 Baidu 帮助下，我做成了，而且也满足我的预期，下面是这个小程序的地址，里面包含了程序本体和项目的说明文件，希望能帮助你。

项目地址：https://github.com/jacksparrowFF2/Valkyrie
